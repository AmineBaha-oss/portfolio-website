        ...
        <div className={`${styles.grid} ${styles.cols2}`}>
          {projects.map((project, index) => {
            const title =
              ...
              project.title &&
              locale in project.title
                ? project.title[locale]
                : String(project.title ?? "");
            const description =
              typeof project.description === "object" &&
              project.description &&
              locale in project.description
                ...
                >
                  ...
                  <span className={styles.badge}>
                    {project.status === "published"
                      ? t("dashboardProjects.published")
                      : t("dashboardProjects.draft")}
                  </span>
                </div>
  ...
  useEffect(() => {
    if (project) {
      ...
      const description =
        typeof project.description === "object"
          ? project.description
          : { en: project.description, fr: "" };
      const fullDescription =
        project.fullDescription && typeof project.fullDescription === "object"
