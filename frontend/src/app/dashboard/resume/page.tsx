        ...
        >
          ...
          >
            <label style={{ color: "white", fontWeight: "500" }}>
              {t("dashboardResume.viewResume")}:
            </label>
            <select
              value={selectedLanguage}
              onChange={(e) =>
                setSelectedLanguage(e.target.value as "en" | "fr")
              }
              style={{
                padding: "0.5rem 1rem",
                fontSize: "1rem",
            ...
            >
              <option value="en" style={{ backgroundColor: "#1a1a1a" }}>
                English
              </option>
              <option value="fr" style={{ backgroundColor: "#1a1a1a" }}>
                Français
              </option>
            </select>
          </div>
            ...
            {uploadedCV ? (
              <div>
                ...
                >
                  ...
                  >
                    {t("dashboardResume.uploaded")}:{" "}
                    {new Date(uploadedCV.createdAt).toLocaleDateString()}
                  </div>
                </div>
            ...
            {!uploadedCV ? (
              ...
              >
                <svg
                  ...
                  stroke="currentColor"
                  strokeWidth="1.5"
                  style={{ margin: "0 auto 1rem", opacity: 0.7 }}
                >
                  <path
